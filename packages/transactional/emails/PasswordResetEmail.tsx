...
export default function PasswordResetEmail({ name, link, locale }: PasswordResetEmailProps) {
		...
		<Tailwind config={tailwindConfig}>
			<Html>
				...
				<Body className="bg-surface-container m-0 text-center font-sans">
					<Preview>Troque sua senha</Preview>
						...
						<Section className="w-full text-center pb-2">
							<Row>
								<Column className="w-1/2 align-middle" align="left">
									<Img src={`${baseUrl}/logo-monochrome.svg`} alt="ops" width={24} className="block" />
								</Column>
								...
								<Column className="w-full align-middle" align="center">
									...
									<Row>
										<Column className="w-full" align="center">
											{/* logo */}
											<Img src={`${baseUrl}/petal-export.svg`} alt="ops" width={64} className="block" />
											{/* title */}
											...
											<Text className="text-center">
												<span className="text-body-s-regular text-text-primary">
													Alguém enviou uma solicitação de troca da sua senha, você pode fazer a troca a partir do link
													abaixo.
												</span>
											</Text>
										</Column>
									...
									<Row>
										<Text>
											<span className="text-text-secondary body-s-regular">
												Caso não tenha sido você, pode ignorar esse e-mail. Sua conta está segura com a gente.
											</span>
										</Text>
									</Row>
								</Column>
								...
								<Column className="w-full" align="center">
									<Row className="w-full" align="center">
										<Text className="max-w-[240px] text-center">
											<span className="text-text-secondary text-body-s-medium">
												Because managing your plans should feel this easy.
											</span>
										</Text>
									</Row>
									<Row className="align-middle" align="center">
										<Link href="https://github.com/angeluciel/planici" className="px-2">
										...
										<Link href="https://example.com" className="px-2">
											<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-6">
